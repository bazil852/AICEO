...
```json
{
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Filter by metadata. Replace <key> with the metadata key you want to filter on."
          },
          {
            "name": "page",
            "required": false,
          ...
          },
          {
            ...
            "description": "When present, uses cursor-based pagination instead of offset pagination."
          }
        ],
        "tags": [
          "bot"
  ...
  "components": {
    "schemas": {
      ...
      "AutomaticLeave": {
        ...
        "properties": {
          "waiting_room_timeout": {
            ...
            "minimum": 30,
            "default": 1200,
            "description": "The number of seconds after which the bot will automatically leave the call, if it has not been let in from the waiting room. If you join Zoom using an OBF token, this timeout also caps how long the bot will wait for the associated user to join the meeting; if the user never joins before the timeout, the join fails with zoom_obf_user_not_in_meeting. Note that this has a max value of 600 seconds for Google Meet and 1800 for Microsoft Teams."
          },
          ...
          "everyone_left_timeout": {
            "allOf": [
              {
                "$ref": "#/components/schemas/AutomaticLeaveEveryoneLeft"
              }
            ],
      ...
      "Bot": {
        ...
        "properties": {
          ...
          "join_at": {
            ...
            "format": "date-time",
            "nullable": true,
            "description": "The time at which the bot will join the call, formatted in ISO 8601. This field can only be read from scheduled bots that have not yet joined a call."
          },
          "recording_config": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfig"
              }
            ],
            "nullable": true,
          ...
          "slack_team": {
            "allOf": [
              {
                "$ref": "#/components/schemas/SlackTeamIntegrationMinimal"
              }
            ],
            "readOnly": true,
            "nullable": true
          ...
          "webex": {
            "allOf": [
              {
                "$ref": "#/components/schemas/Webex"
              }
            ],
            "nullable": true,
            "description": "Webex specific parameters"
          },
          "breakout_room": {
            "allOf": [
              {
                "$ref": "#/components/schemas/_BreakoutRoomSchema"
              }
            ],
            "nullable": true,
      ...
      "BotRecordingConfig": {
        ...
        "properties": {
          "transcript": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigTranscriptArtifact"
              }
            ],
            "nullable": true,
          ...
          "realtime_endpoints": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/BotRecordingConfigRealtimeEndpoint"
            },
            "default": [],
          ...
          "retention": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigRetention"
              }
            ],
            "nullable": true,
          ...
          "video_mixed_layout": {
            "allOf": [
              {
                "$ref": "#/components/schemas/VideoMixedLayoutEnum"
              }
            ],
          ...
          "video_mixed_mp4": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigBaseArtifact"
              }
            ],
            "nullable": true,
          ...
          "video_mixed_participant_video_when_screenshare": {
            "allOf": [
              {
                "$ref": "#/components/schemas/VideoMixedParticipantVideoWhenScreenshareEnum"
              }
            ],
            "default": "overlap",
      ...
      "BotRecordingConfigBaseArtifact": {
        "type": "object",
        "properties": {
          "metadata": {
            "type": "object",
      ...
      "BotRecordingConfigRealtimeEndpoint": {
        "type": "object",
        "properties": {
          "metadata": {
            "type": "object",
          ...
          "type": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigRealtimeEndpointSharedTypeEnum"
              }
            ],
      ...
      "BotRecordingConfigRealtimeEndpointSharedTypeEnum": {
        "enum": [
          "rtmp",
          "websocket",
          "webhook",
      ...
      "BotRecordingConfigRetention": {
        "type": "object",
        "properties": {
          "type": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigRetentionSharedTypeEnum"
              }
            ],
      ...
      "BotRecordingConfigRetentionSharedTypeEnum": {
        "enum": [
          "timed",
          "forever"
        ],
      ...
      "BotRecordingConfigTranscriptArtifact": {
        "type": "object",
        "properties": {
          "metadata": {
            "type": "object",
          ...
          "provider": {
            "allOf": [
              {
                "$ref": "#/components/schemas/BotRecordingConfigTranscriptProvider"
              }
            ],
          ...
          "diarization": {
            "$ref": "#/components/schemas/BotRecordingConfigTranscriptDiarization"
          }
        },
        "required": [
          "provider"
      ...
      "BotRecordingConfigTranscriptDiarization": {
        "type": "object",
        "properties": {
      ...
      "BotRecordingConfigTranscriptProvider": {
        "type": "object",
        "properties": {
          "recallai_streaming": {
            "allOf": [
          ...
          "meeting_captions": {
            "allOf": [
              {
                "$ref": "#/components/schemas/MeetingCaptions"
              }
            ],
      ...
      "BotVariant": {
        ...
        "properties": {
          ...
          "webex": {
            "allOf": [
              {
                "$ref": "#/components/schemas/WebexEnum"
              }
            ],
      ...
      "GmeetMeetingInviteMeetingLink": {
        ...
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/GmeetMeetingInviteMeetingLinkPlatformEnum"
          },
          "meeting_id": {
            "type": "string"
          }
      ...
      "GmeetMeetingInviteMeetingLinkPlatformEnum": {
        "enum": [
          "google_meet"
        ],
        "type": "string",
        "description": "* `google_meet` - google_meet"
      },
      "GoogleMeet": {
        "type": "object",
        "properties": {
      ...
      "GotoMeetingInviteMeetingLink": {
        ...
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/GotoMeetingInviteMeetingLinkPlatformEnum"
          },
          "meeting_id": {
            "type": "string"
          }
      ...
      "GotoMeetingInviteMeetingLinkPlatformEnum": {
        "enum": [
          "goto_meeting"
        ],
        "type": "string",
        "description": "* `goto_meeting` - goto_meeting"
      },
      "LanguageCodeC40Enum": {
        "enum": [
          "auto",
      ...
      "MeetingCaptions": {
        ...
        "properties": {
          "language_code": {
            ...
            "allOf": [
              {
                "$ref": "#/components/schemas/MeetingCaptionsLanguageCodeEnum"
              }
            ]
          }
        }
      },
      "MeetingCaptionsLanguageCodeEnum": {
        "enum": [
          "cs",
          "de",
          "en",
      ...
      "MeetingInvite": {
        "oneOf": [
          {
            "$ref": "#/components/schemas/WebexMeetingInvite"
          },
          {
            "$ref": "#/components/schemas/GmeetMeetingInviteMeetingLink"
          },
          {
            "$ref": "#/components/schemas/GotoMeetingInviteMeetingLink"
          },
          {
            "$ref": "#/components/schemas/TeamsLiveMeetingInviteMeetingLink"
          },
          {
            "$ref": "#/components/schemas/TeamsMeetingInviteMeetingLink"
          },
          {
            "$ref": "#/components/schemas/ZoomMeetingInviteMeetingLink"
          }
        ],
        "discriminator": {
          "propertyName": "platform",
          "mapping": {
            "webex": "#/components/schemas/WebexMeetingInvite",
            "google_meet": "#/components/schemas/GmeetMeetingInviteMeetingLink",
            "goto_meeting": "#/components/schemas/GotoMeetingInviteMeetingLink",
            "microsoft_teams_live": "#/components/schemas/TeamsLiveMeetingInviteMeetingLink",
            "microsoft_teams": "#/components/schemas/TeamsMeetingInviteMeetingLink",
            "zoom": "#/components/schemas/ZoomMeetingInviteMeetingLink"
          }
        }
      },
      ...
      "OutputMedia": {
        ...
        "properties": {
          "camera": {
            "$ref": "#/components/schemas/OutputMediaConfig"
          },
          "screenshare": {
            "$ref": "#/components/schemas/OutputMediaConfig"
          }
      ...
      "OutputMediaWebpage": {
        ...
        "properties": {
          "kind": {
            "$ref": "#/components/schemas/OutputMediaWebpageKindEnum"
          },
          "config": {
            "$ref": "#/components/schemas/OutputMediaWebpageConfig"
          }
        },
        "required": [
          "config",
      ...
      "TeamsLiveMeetingInviteMeetingLink": {
        ...
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/TeamsLiveMeetingInviteMeetingLinkPlatformEnum"
          },
          "meeting_id": {
            "type": "string"
          },
      ...
      "TeamsLiveMeetingInviteMeetingLinkPlatformEnum": {
        "enum": [
          "microsoft_teams_live"
        ],
        "type": "string",
        "description": "* `microsoft_teams_live` - microsoft_teams_live"
      },
      "TeamsMeetingInviteMeetingLink": {
        "type": "object",
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/TeamsMeetingInviteMeetingLinkPlatformEnum"
          },
          "meeting_id": {
            "type": "string",
            "nullable": true
      ...
      "TeamsMeetingInviteMeetingLinkPlatformEnum": {
        "enum": [
          "microsoft_teams"
        ],
        "type": "string",
        "description": "* `microsoft_teams` - microsoft_teams"
      },
      ...
      "VideoMixedParticipantVideoWhenScreenshareEnum": {
        "enum": [
          "hide",
          "beside",
          "overlap"
      ...
      "Webex": {
        ...
        "properties": {
          "login_group_name": {
            "type": "string",
            "default": "Default",
            "description": "The name of the Webex login group to use for this meeting."
          }
        }
      },
      "WebexEnum": {
      ...
      "WebexMeetingInvite": {
        ...
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/WebexMeetingInvitePlatformEnum"
          },
          "meeting_subdomain": {
            "type": "string"
          },
          "meeting_personal_room_id": {
            "type": "string",
            "description": "Required for personal room meetings."
          },
          "meeting_mtid": {
            "type": "string",
            "description": "Required for scheduled/spaces meetings."
          },
          "meeting_path": {
            "type": "string",
            "description": "Required for scheduled/spaces meetings."
      ...
      "WebexMeetingInvitePlatformEnum": {
        "enum": [
          "webex"
        ],
        "type": "string",
        "description": "* `webex` - webex"
      },
      "Zoom": {
        "type": "object",
        "properties": {
      ...
      "ZoomMeetingInviteMeetingLink": {
        ...
        "properties": {
          "platform": {
            "$ref": "#/components/schemas/ZoomMeetingInviteMeetingLinkPlatformEnum"
          },
          "meeting_id": {
            "type": "string"
          },
      ...
      "ZoomMeetingInviteMeetingLinkPlatformEnum": {
        "enum": [
          "zoom"
        ],
        "type": "string",
      ...
      "_BreakoutRoomSchema": {
        ...
        "properties": {
          ...
          "room_id": {
            "type": "string",
            "format": "uuid",
            "description": "Required when mode='join_specific_room'."
          }
        },
        "required": [
          "mode"
